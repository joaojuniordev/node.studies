...
module.exports = {
    ...
    APP: {
        ...
        UPLOAD_DIR: (process.env.JJRDEV_APP_UPLOAD_DIR) ? process.env.JJRDEV_UPLOAD_DIR : "./storage/upload",
        UPLOAD_ENABLED: (process.env.JJRDEV_APP_UPLOAD_ENABLED === "true") ? true : false,//CAST Bool
